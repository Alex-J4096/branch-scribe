...
CREATE TABLE IF NOT EXISTS model_profiles (
    ...
    created_at TIMESTAMPTZ NOT NULL DEFAULT now(),
    updated_at TIMESTAMPTZ NOT NULL DEFAULT now(),
    CONSTRAINT model_profiles_api_key_ref_check CHECK (api_key_ref IS NULL OR api_key_ref LIKE 'env:%'),
    CONSTRAINT model_profiles_provider_check CHECK (provider IN ('openai_compatible', 'openai', 'anthropic', 'gemini', 'openrouter', 'deepseek', 'moonshot', 'siliconflow')),
